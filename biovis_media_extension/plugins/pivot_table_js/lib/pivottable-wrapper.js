function PivotTableViewer(divId, configs) {
    ...
    if (pivotInstance) {
        $('#' + divId).html("<div class='alert alert-warning' role='alert' style='width: 100%;min-height: 300px; display: flex; justify-content: center; align-items: center;'><pre class='highlight'><code>Only one pivot-table-js plugin can be added into a biovis report.<br>If you have any questions, Please contact the plugin developer.</pre></code></div>");
        return
    }
