...
WebDataRocksToolbar.prototype.getTabs = function () {
    ...
    // Chart tab
    tabs.push({
        title: Labels.chart, id: "wdr-tab-chart", mobile: false, icon: this.icons.chart, rightGroup: true,
        menu: [
            { title: Labels.chart_none, id: "wdr-tab-chart-none", handler: this.chartHandler, args: "none", icon: this.icons.chart_none },
            { title: Labels.chart_barchart, id: "wdr-tab-chart-barchart", handler: this.chartHandler, args: "barchart", icon: this.icons.chart_barchart },
            { title: Labels.chart_areaspline, id: "wdr-tab-chart-areaspline", handler: this.chartHandler, args: "areaspline", icon: this.icons.chart_areaspline },
            { title: Labels.chart_arearange, id: "wdr-tab-chart-arearange", handler: this.chartHandler, args: "arearange", icon: this.icons.chart_arearange },
            { title: Labels.chart_areasplinerange, id: "wdr-tab-chart-areasplinerange", handler: this.chartHandler, args: "areasplinerange", icon: this.icons.chart_areasplinerange },
            { title: Labels.chart_area, id: "wdr-tab-chart-area", handler: this.chartHandler, args: "area", icon: this.icons.chart_area },
            { title: Labels.chart_column, id: "wdr-tab-chart-column", handler: this.chartHandler, args: "column", icon: this.icons.chart_column },
            { title: Labels.chart_bubble, id: "wdr-tab-chart-bubble", handler: this.chartHandler, args: "bubble", icon: this.icons.chart_bubble },
            { title: Labels.chart_columnrange, id: "wdr-tab-chart-columnrange", handler: this.chartHandler, args: "columnrange", icon: this.icons.chart_columnrange },
            { title: Labels.chart_errorbar, id: "wdr-tab-chart-errorbar", handler: this.chartHandler, args: "errorbar", icon: this.icons.chart_errorbar },
            { title: Labels.chart_line, id: "wdr-tab-chart-line", handler: this.chartHandler, args: "line", icon: this.icons.chart_line },
            { title: Labels.chart_pie, id: "wdr-tab-chart-pie", handler: this.chartHandler, args: "pie", icon: this.icons.chart_pie },
            { title: Labels.chart_funnel, id: "wdr-tab-chart-funnel", handler: this.chartHandler, args: "funnel", icon: this.icons.chart_funnel },
            { title: Labels.chart_polygon, id: "wdr-tab-chart-polygon", handler: this.chartHandler, args: "polygon", icon: this.icons.chart_polygon },
            { title: Labels.chart_pyramid, id: "wdr-tab-chart-pyramid", handler: this.chartHandler, args: "pyramid", icon: this.icons.chart_pyramid },
            { title: Labels.chart_scatter, id: "wdr-tab-chart-scatter", handler: this.chartHandler, args: "scatter", icon: this.icons.chart_scatter },
            { title: Labels.chart_spline, id: "wdr-tab-chart-spline", handler: this.chartHandler, args: "spline", icon: this.icons.chart_spline },
            { title: Labels.chart_waterfall, id: "wdr-tab-chart-waterfall", handler: this.chartHandler, args: "waterfall", icon: this.icons.chart_waterfall }
        ]
    });
...
WebDataRocksToolbar.prototype.updateLabels = function (labels) {
    ...
    this.setText(document.querySelector("#wdr-tab-chart > a > span"), Labels.chart)
    this.setText(document.querySelector("#wdr-tab-chart-barchart > a > span"), Labels.chart_barchart)
    this.setText(document.querySelector("#wdr-tab-chart-areaspline > a > span"), Labels.chart_areaspline)
    this.setText(document.querySelector("#wdr-tab-chart-arearange > a > span"), Labels.chart_arearange)
    this.setText(document.querySelector("#wdr-tab-chart-areasplinerange > a > span"), Labels.chart_areasplinerange)
    this.setText(document.querySelector("#wdr-tab-chart-area > a > span"), Labels.chart_area)
    this.setText(document.querySelector("#wdr-tab-chart-column > a > span"), Labels.chart_column)
    this.setText(document.querySelector("#wdr-tab-chart-bubble > a > span"), Labels.chart_bubble)
    this.setText(document.querySelector("#wdr-tab-chart-columnrange > a > span"), Labels.chart_columnrange)
    this.setText(document.querySelector("#wdr-tab-chart-errorbar > a > span"), Labels.chart_errorbar)
    this.setText(document.querySelector("#wdr-tab-chart-line > a > span"), Labels.chart_line)
    this.setText(document.querySelector("#wdr-tab-chart-pie > a > span"), Labels.chart_pie)
    this.setText(document.querySelector("#wdr-tab-chart-funnel > a > span"), Labels.chart_funnel)
    this.setText(document.querySelector("#wdr-tab-chart-polygon > a > span"), Labels.chart_polygon)
    this.setText(document.querySelector("#wdr-tab-chart-pyramid > a > span"), Labels.chart_pyramid)
    this.setText(document.querySelector("#wdr-tab-chart-scatter > a > span"), Labels.chart_scatter)
    this.setText(document.querySelector("#wdr-tab-chart-spline > a > span"), Labels.chart_spline)
    this.setText(document.querySelector("#wdr-tab-chart-waterfall > a > span"), Labels.chart_waterfall)
    this.setText(document.querySelector("#wdr-tab-chart-none > a > span"), Labels.chart_none)
...
WebDataRocksToolbar.prototype.icons = {
    ...
    chart: '<svg t="1552910218774" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6186" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="32"><defs><style type="text/css"></style></defs><path d="M0 0l0 896 1024 0 0-128-896 0 0-768-128 0zm640 0l0 640 256 0 0-640-256 0zm-384 256l0 384 256 0 0-384-256 0z" p-id="6187" fill="#999999"></path></svg>',
    chart_none: '<svg t="1552931829906" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4912" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M808 602.9c-23.6 164.2-181.8 285.5-358.7 248.3C336.9 827.6 245.6 736.8 222 624.4c-40.3-192 92-361.8 290.4-361.8v99.2l248-148.8-248-148.8v99.2c-248 0-438 222.4-388.6 476.5 30.1 154.7 155 279.4 309.7 309.5C668 995 875.6 833.9 906.2 616.1c4.2-29.6-19.7-55.8-49.5-55.8h0.1c-24.7 0-45.3 18.2-48.8 42.6z" p-id="4913" fill="#999999"></path></svg>',
    chart_barchart: '<svg t="1552910218774" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6186" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30"><defs><style type="text/css"></style></defs><path d="M0 0l0 896 1024 0 0-128-896 0 0-768-128 0zm640 0l0 640 256 0 0-640-256 0zm-384 256l0 384 256 0 0-384-256 0z" p-id="6187" fill="#999999"></path></svg>',
    chart_area: '<svg t="1552929620351" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4502" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M888 792H200V168c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v688c0 4.4 3.6 8 8 8h752c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8z" p-id="4503" fill="#999999"></path><path d="M272 728h536c4.4 0 8-3.6 8-8V284c0-7.2-8.7-10.7-13.7-5.7L592 488.6l-125.4-124c-3.1-3.1-8.2-3.1-11.3 0l-189 189.6c-1.5 1.5-2.3 3.5-2.3 5.6V720c0 4.4 3.6 8 8 8z" p-id="4504" fill="#999999"></path></svg>',
    chart_areaspline: '<svg t="1552929552367" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1972" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M744.533333 647.68 938.666667 311.893333 938.666667 810.666667 938.666667 896 85.333333 896 85.333333 128 170.666667 128 170.666667 663.04 405.333333 256 682.666667 417.28 863.573333 104.533333 937.386667 147.2 714.24 533.333333 436.48 373.333333 183.893333 810.666667 280.32 810.666667 467.626667 488.106667 744.533333 647.68Z" p-id="1973" fill="#999999"></path></svg>',
    chart_arearange: '<svg t="1552929552367" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1972" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M744.533333 647.68 938.666667 311.893333 938.666667 810.666667 938.666667 896 85.333333 896 85.333333 128 170.666667 128 170.666667 663.04 405.333333 256 682.666667 417.28 863.573333 104.533333 937.386667 147.2 714.24 533.333333 436.48 373.333333 183.893333 810.666667 280.32 810.666667 467.626667 488.106667 744.533333 647.68Z" p-id="1973" fill="#999999"></path></svg>',
    chart_areasplinerange: '<svg t="1552929552367" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1972" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M744.533333 647.68 938.666667 311.893333 938.666667 810.666667 938.666667 896 85.333333 896 85.333333 128 170.666667 128 170.666667 663.04 405.333333 256 682.666667 417.28 863.573333 104.533333 937.386667 147.2 714.24 533.333333 436.48 373.333333 183.893333 810.666667 280.32 810.666667 467.626667 488.106667 744.533333 647.68Z" p-id="1973" fill="#999999"></path></svg>',
    chart_spline: '<svg t="1552929552367" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1972" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M744.533333 647.68 938.666667 311.893333 938.666667 810.666667 938.666667 896 85.333333 896 85.333333 128 170.666667 128 170.666667 663.04 405.333333 256 682.666667 417.28 863.573333 104.533333 937.386667 147.2 714.24 533.333333 436.48 373.333333 183.893333 810.666667 280.32 810.666667 467.626667 488.106667 744.533333 647.68Z" p-id="1973" fill="#999999"></path></svg>',
    chart_bubble: '<svg t="1552929661831" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5420" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M307.2 614.4m-136.533333 0a136.533333 136.533333 0 1 0 273.066666 0 136.533333 136.533333 0 1 0-273.066666 0Z" p-id="5421" fill="#999999"></path><path d="M631.466667 768m-85.333334 0a85.333333 85.333333 0 1 0 170.666667 0 85.333333 85.333333 0 1 0-170.666667 0Z" p-id="5422" fill="#999999"></path><path d="M648.533333 375.466667m-204.8 0a204.8 204.8 0 1 0 409.6 0 204.8 204.8 0 1 0-409.6 0Z" p-id="5423" fill="#999999"></path></svg>',
    chart_scatter: '<svg t="1552929843260" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11770" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M990.2 1024H33.8C15.2 1024 0 1008.8 0 990.2V33.8C0 15.2 15.2 0 33.8 0c18.7 0 33.8 15.2 33.8 33.8v888.6c0 18.7 15.2 33.8 33.8 33.8H990c18.7 0 33.8 15.2 33.8 33.8 0.2 18.8-15 34-33.6 34z" p-id="11771" fill="#999999"></path><path d="M189 883.9c-24.3 0-44-19.7-44-44s19.7-44 44-44 44 19.7 44 44-19.7 44-44 44zM269 745.9c-28.7 0-52-23.3-52-52s23.3-52 52-52 52 23.3 52 52-23.3 52-52 52zM321 594.2c-36.6 0-66.3-29.7-66.3-66.3 0-36.6 29.7-66.3 66.3-66.3 36.6 0 66.3 29.7 66.3 66.3 0 36.6-29.7 66.3-66.3 66.3zM441 867.9c-26.5 0-48-21.5-48-48s21.5-48 48-48 48 21.5 48 48-21.5 48-48 48zM517 691.9c-22.1 0-40-17.9-40-40s17.9-40 40-40 40 17.9 40 40-17.9 40-40 40zM589 519.9c-28.7 0-52-23.3-52-52s23.3-52 52-52 52 23.3 52 52-23.3 52-52 52zM689 306.2c-36.6 0-66.3-29.7-66.3-66.3 0-36.6 29.7-66.3 66.3-66.3 36.6 0 66.3 29.7 66.3 66.3 0 36.6-29.7 66.3-66.3 66.3zM761 711.9c-22.1 0-40-17.9-40-40s17.9-40 40-40 40 17.9 40 40-17.9 40-40 40zM665 863.9c-15.5 0-28-12.5-28-28s12.5-28 28-28 28 12.5 28 28-12.5 28-28 28zM841 541.9c-26.5 0-48-21.5-48-48s21.5-48 48-48 48 21.5 48 48-21.5 48-48 48zM923 338.8c-18.2 0-32.9-14.7-32.9-32.9 0-18.1 14.7-32.9 32.9-32.9 18.1 0 32.9 14.7 32.9 32.9 0 18.1-14.7 32.9-32.9 32.9z" p-id="11772" fill="#999999"></path></svg>',
    chart_funnel: '<svg t="1552929785516" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10601" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M311.657143 596.571429h400.685714l97.028572-169.142858H214.628571z m621.028571-493.714286H91.314286c-28 0-45.485714 30.514286-31.428572 54.857143L172.571429 354.285714h678.857142l112.8-196.571428c13.942857-24.342857-3.542857-54.857143-31.542857-54.857143zM325.714286 884.571429c0 20.228571 16.228571 36.571429 36.342857 36.571428h299.885714c20.114286 0 36.342857-16.342857 36.342857-36.571428V669.714286H325.714286v214.857143z" p-id="10602" fill="#999999"></path></svg>',
    chart_line: '<svg t="1552929694274" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6358" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M888 792H200V168c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v688c0 4.4 3.6 8 8 8h752c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8z" p-id="6359" fill="#999999"></path><path d="M305.8 637.7c3.1 3.1 8.1 3.1 11.3 0l138.3-137.6L583 628.5c3.1 3.1 8.2 3.1 11.3 0l275.4-275.3c3.1-3.1 3.1-8.2 0-11.3l-39.6-39.6c-3.1-3.1-8.2-3.1-11.3 0l-230 229.9L461.4 404c-3.1-3.1-8.2-3.1-11.3 0L266.3 586.7c-3.1 3.1-3.1 8.2 0 11.3l39.5 39.7z" p-id="6360" fill="#999999"></path></svg>',
    chart_errorbar: '<svg t="1552929694274" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6358" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M888 792H200V168c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v688c0 4.4 3.6 8 8 8h752c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8z" p-id="6359" fill="#999999"></path><path d="M305.8 637.7c3.1 3.1 8.1 3.1 11.3 0l138.3-137.6L583 628.5c3.1 3.1 8.2 3.1 11.3 0l275.4-275.3c3.1-3.1 3.1-8.2 0-11.3l-39.6-39.6c-3.1-3.1-8.2-3.1-11.3 0l-230 229.9L461.4 404c-3.1-3.1-8.2-3.1-11.3 0L266.3 586.7c-3.1 3.1-3.1 8.2 0 11.3l39.5 39.7z" p-id="6360" fill="#999999"></path></svg>',
    chart_pie: '<svg t="1552929767616" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9859" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M873.813333 849.92c78.506667-85.333333 129.706667-197.973333 133.12-320.853333H552.96l320.853333 320.853333z" fill="#999999" p-id="9860"></path><path d="M498.346667 518.826667V17.066667C228.693333 27.306667 17.066667 245.76 17.066667 512c0 273.066667 221.866667 494.933333 494.933333 494.933333 129.706667 0 249.173333-51.2 337.92-133.12L501.76 522.24c-3.413333 0-3.413333-3.413333-3.413333-3.413333z" fill="#999999" p-id="9861"></path><path d="M529.066667 17.066667v477.866666h477.866666c-10.24-259.413333-218.453333-467.626667-477.866666-477.866666z" fill="#999999" p-id="9862"></path></svg>',
    chart_polygon: '<svg t="1552929807509" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10961" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M716.8 176.355556L898.844444 512l-182.044444 335.644444H307.2l-182.044444-341.333333L307.2 170.666667h409.6v5.688889z m39.822222-62.577778H267.377778L56.888889 506.311111l210.488889 392.533333h483.555555L967.111111 506.311111 756.622222 113.777778z" p-id="10962" fill="#999999"></path><path d="M716.8 176.355556L898.844444 512l-182.044444 335.644444H307.2l-182.044444-341.333333L307.2 170.666667h409.6v5.688889z" p-id="10963" fill="#999999"></path></svg>',
    chart_pyramid: '<svg t="1552929826039" class="icon" style="" viewBox="0 0 1307 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11360" xmlns:xlink="http://www.w3.org/1999/xlink" width="45.94921875" height="36"><defs><style type="text/css"></style></defs><path d="M1303.769872 989.772255l-631.829787-980.425532c-8.039489-12.462298-28.606638-12.462298-36.646128 0l-631.829787 980.425532A21.74366 21.74366 0 0 0 21.787234 1023.346383h1176.510638a21.787234 21.787234 0 1 0 0-43.574468H980.425532v-174.297872h152.728511l133.969702 207.893787a21.852596 21.852596 0 0 0 30.131744 6.492596 21.765447 21.765447 0 0 0 6.514383-30.088171zM653.617021 61.352851l170.637617 264.802043H531.739234a21.787234 21.787234 0 1 0 0 43.574468H631.829787v174.297872H342.560681L653.617021 61.352851zM522.893617 587.601702h261.446809v174.297872H522.893617v-174.297872z m-152.510638 217.872341h261.446808v174.297872H370.382979v-174.297872z m-55.906043-217.872341H479.319149v174.297872H250.553191a21.787234 21.787234 0 1 0 0 43.574469H326.808511v174.297872H61.745021l252.731915-392.170213zM675.404255 805.474043h261.446809v174.297872H675.404255v-174.297872z m152.510639-43.574469v-174.297872h87.148936a21.787234 21.787234 0 1 0 0-43.574468H675.404255v-174.297872h176.934128l252.753702 392.170212H827.914894z" fill="#999999" p-id="11361"></path></svg>',
    chart_waterfall: '<svg t="1552929872329" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12108" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M88.064 513.024c11.264 0 20.48-9.216 20.48-20.48v-102.4c0-11.264-9.216-20.48-20.48-20.48s-20.48 9.216-20.48 20.48v102.4c0 11.264 9.216 20.48 20.48 20.48zM88.064 308.224c11.264 0 20.48-9.216 20.48-20.48v-87.04c0-11.264-9.216-20.48-20.48-20.48s-20.48 9.216-20.48 20.48v87.04c0 11.264 9.216 20.48 20.48 20.48zM108.544 890.88v-91.136c0-11.264-9.216-20.48-20.48-20.48s-20.48 9.216-20.48 20.48V890.88c0 5.12 1.024 11.264 2.048 16.384 2.048 9.216 10.24 15.36 19.456 15.36 2.048 0 4.096 0 5.12-1.024 11.264-3.072 17.408-14.336 14.336-25.6V890.88zM88.064 717.824c11.264 0 20.48-9.216 20.48-20.48v-102.4c0-11.264-9.216-20.48-20.48-20.48s-20.48 9.216-20.48 20.48v102.4c0 11.264 9.216 20.48 20.48 20.48zM690.176 911.36h-102.4c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h102.4c11.264 0 20.48-9.216 20.48-20.48s-9.216-20.48-20.48-20.48zM485.376 911.36h-102.4c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h102.4c11.264 0 20.48-9.216 20.48-20.48s-9.216-20.48-20.48-20.48zM280.576 911.36h-102.4c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h102.4c11.264 0 20.48-9.216 20.48-20.48s-9.216-20.48-20.48-20.48z" p-id="12109" fill="#999999"></path><path d="M896 71.68H129.024c-33.792 0-61.44 27.648-61.44 61.44 0 11.264 9.216 20.48 20.48 20.48s20.48-9.216 20.48-20.48 9.216-20.48 20.48-20.48h766.976c11.264 0 20.48 9.216 20.48 20.48v106.496H160.768c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h755.712v126.976H329.728c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h586.752v126.976H595.968c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h320.512v126.976H713.728c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h202.752V890.88c0 11.264-9.216 20.48-20.48 20.48h-102.4c-11.264 0-20.48 9.216-20.48 20.48s9.216 20.48 20.48 20.48h102.4c33.792 0 61.44-27.648 61.44-61.44V133.12c0-33.792-27.648-61.44-61.44-61.44z" p-id="12110" fill="#999999"></path></svg>',
    chart_column: '<svg t="1552930555464" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="15645" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M681.984 214.016l214.016 0 0 553.984-214.016 0 0-553.984zM169.984 768l0-553.984 214.016 0 0 553.984-214.016 0zM425.984 768l0-553.984 214.016 0 0 553.984-214.016 0z" p-id="15646" fill="#999999"></path></svg>',
    chart_columnrange: '<svg t="1552930555464" class="icon" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="15645" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36"><defs><style type="text/css"></style></defs><path d="M681.984 214.016l214.016 0 0 553.984-214.016 0 0-553.984zM169.984 768l0-553.984 214.016 0 0 553.984-214.016 0zM425.984 768l0-553.984 214.016 0 0 553.984-214.016 0z" p-id="15646" fill="#999999"></path></svg>',
...
// Chart tab
WebDataRocksToolbar.prototype.chartHandler = function (chartType) {
    var self = this
    var storage = window.sessionStorage;
    storage.setItem("pivot-current-chart", chartType);
    self.pivot.refresh();
}
// Fullscreen tab
...
WebDataRocksToolbar.prototype.filterConnectMenu = function () {
    var menu = [];
    var Labels = this.Labels;
    menu.push({ title: Labels.connect_local_csv, id: "wdr-tab-connect-local-csv", handler: this.connectLocalCSVHandler, mobile: false, icon: this.icons.connect_csv });
    menu.push({ title: Labels.connect_local_json, id: "wdr-tab-connect-local-json", handler: this.connectLocalJSONHandler, mobile: false, icon: this.icons.connect_json });
    menu.push({ title: this.osUtils.isMobile ? Labels.connect_remote_csv_mobile : Labels.connect_remote_csv, id: "wdr-tab-connect-remote-csv", handler: this.connectRemoteCSV, icon: this.icons.connect_csv });
    if (this.dataProvider[0] && this.dataProvider[0].id == "wdr-tab-connect") {
